...
data class Client (@PrimaryKey(autoGenerate = true)
                   ...
                   @ColumnInfo(name = COLUMN_PERGUNTA_SEGURANCA) var perguntaSeguranca: String = "",
                   @ColumnInfo(name = COLUMN_CNPJ) var cnpj: String = "",
                   @ColumnInfo(name = COLUMN_TELEFONE) var telefone: String = "",
                   @ColumnInfo(name = COLUMN_MESAS) var mesas: Int = -1,
